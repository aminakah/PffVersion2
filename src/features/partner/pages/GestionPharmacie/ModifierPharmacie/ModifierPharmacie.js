...
function ModifierPharmacie() {
  ...
  useEffect(() => {
    ...
    .then(response => {
      ...
      .then(response => { 
          loadDepartment(response.data.pharmacie.region.id);
          loadQuartier(response.data.pharmacie.departement.id); 
          setPharmacie(response.data.pharmacie);
          setValue('nom', response.data.pharmacie.nom)
          setValue('telephone', response.data.pharmacie.telephone)
          setValue('fax', response.data.pharmacie.fax)
          setValue('adresse', response.data.pharmacie.adresse)
          setValue('region', response.data.pharmacie.region)
          setValue('nom', response.data.pharmacie.nom)
          setValue('quartier_id', response.data.pharmacie.quartier_id)
      })
    })
  },[])
  ...
  const onSubmit = (data) => {
    data.id = pharmacie.id;
    data.photo = data.photo[0];
    ProprietaireService.modifierPharmacie(data).then((response) => {
  ...
  return (
    <div className="AdminHomePage container-fluid p-0 m-0">
      <div className="d-flex">
        <SideNavBarPro />
        {pharmacie && <div className="body mx-3 p-4">
          <div className="mb-5 d-flex justify-content-center px-5">
            <h2 className='color text-center'>Modifier la pharmacie {pharmacie.nom} </h2>
          ...
          <div className="px-5">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="w-100">
                   ...
                   <div className="col-12 col-md-6">
                    <div className="form-group mb-3">
                      ...
                      <select className='form-control w-100'
                       ...
                       value={pharmacie.departement.id}
                ...
                <div className="row">
                  ...
                  <div className="col-12 col-md-6">
                    <div className="form-group mb-3">
                      ...
                      <div className='d-flex'>
                        <img src={BASE_URL+'/images/'+ pharmacie.photo} width={40} height={40} alt='imge' />
                        <input
                          className="form-control w-100"
                          type="file"
                ...
                <div className="text-center mt-4">
                  <input className="btn btn-success valider p-2 " type="submit" value="Valider" />
